...
export default function PlanStatus({ me, meLoading, onUsageChanged }) {
  ...
  // Refresh user data when me prop changes (triggered by onUsageChanged callback)
  useEffect(() => {
    if (me && !meLoading) {
      const structuredUser = {
        user: {
  ...
  // Refresh user data when page becomes visible (user navigates back from scan page)
  useEffect(() => {
