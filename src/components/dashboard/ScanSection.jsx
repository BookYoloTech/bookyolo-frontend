...
const ScanSection = ({ onScan }) => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <h1 className="text-2xl font-bold text-primary-800 mb-2">Airbnb Reality Check</h1>
      <p className="text-primary-600 mb-6">Paste an Airbnb listing URL to get AI-powered insights and red flag detection</p>
