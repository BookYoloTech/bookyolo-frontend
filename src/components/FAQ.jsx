...
const FAQ = () => {
  ...
  const faqs = [
    ...
    {
      question: "Does BookYolo cover all Airbnb listings?",
      answer: "Pretty much. If it's on Airbnb, we can scan it."
    },
    {
      question: "Why should I use BookYolo if Airbnb already shows reviews?",
    ...
    },
    {
      ...
      answer: "Yes. Other booking sites are coming soon."
    }
  ];
