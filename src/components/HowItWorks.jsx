    ...
    <section id="how-it-works" className="relative py-14 bg-[#f8fafb] overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex-1">
                  <h3 className="text-base md:text-lg font-semibold text-gray-900">Paste any Airbnb listing link</h3>
                  <p className="mt-1 text-sm text-gray-600">Drop in the URL — works instantly on web and mobile.</p>
                </div>
              </div>
        ...
        <div className="mt-10 rounded-3xl bg-white ring-1 ring-gray-200 shadow-sm p-4 md:p-6 text-center">
          ...
          <p className="text-gray-600 mb-4">Get detailed insights into any Airbnb listing with our AI-powered analysis.</p>
          <button
